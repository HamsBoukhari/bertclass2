...
def get_model():
    ...
    model = BertForSequenceClassification.from_pretrained("hams2/bertclass2")
...
if sgw_op and button:
    ...
    if preds.item() == 0:  # If the predicted class is 0
        ...
        st.write("Workflow: Split On Accounts")  # Workflow classification
        # Link to the prediction app
        st.write("Link to predict CCP Messages: [https://split2-sjfq2jvduxeptamaru7tq2.streamlit.app/](https://split2-sjfq2jvduxeptamaru7tq2.streamlit.app/)")
